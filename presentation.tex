    ...
    \begin{column}{0.32\linewidth}
      \begin{block}{DDPM}
        \begin{itemize}
          ...
          \item Starts generation from Gaussian noise
        \end{itemize}
      \end{block}
    \end{column}
  \end{columns}
...
\begin{frame}{Mode Collapse and Diversity}
  \begin{columns}[T]
    \begin{column}{0.45\linewidth}
      \small
      \begin{itemize}
        \item Mode collapse was checked with sample grids and pixel-space diversity diagnostics.
        \item Final diversity RMSE:
          \begin{itemize}
            \item DCGAN: 0.3682,
            \item VAE: 0.1351,
            \item DDPM: 0.4179.
    ...
    \begin{column}{0.52\linewidth}
      \centering
      \scriptsize
      \textbf{DCGAN stabilisation variants}\\[0.1cm]
      \begin{tabular}{lr}
        \toprule
        Variant & FID \\
        \midrule
        Stronger discriminator & \textbf{143.79} \\
